...
DTYPES_2 = {
    ...
    "mean_ratiodist_1": np.dtype("float16"),
    ...
    "q99_ratiodist_1": np.dtype("float16"),
    "q99_ratiodist_2": np.dtype("float16"),
    ...
    "name_initial_lcs2": np.dtype("int8"),
    "name_initial_lcs": np.dtype("int8"),
    ...
    "name_initial_decode_ld": np.dtype("int8"),
    ...
    "name_num": np.dtype("int8"),
    "address_num": np.dtype("int8"),
    "langs": np.dtype("int8"),
    "cat_simpl": np.dtype("int8"),
    ...
    "name_wratio": np.dtype("int8"),
    "name_partial_ratio": np.dtype("int8"),
